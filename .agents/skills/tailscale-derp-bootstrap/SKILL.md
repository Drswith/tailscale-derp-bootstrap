...
3. Confirm the target has a fixed public IPv4, supported system/architecture, systemd, enough disk, and planned ingress for TCP 80, DERP TCP and STUN UDP while retaining SSH. The scripts do not change cloud security groups, host firewall or tailnet policy.
